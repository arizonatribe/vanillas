/**
 * Gathers an Array of Functions that return Promises and
 * returns an Array of results, once they have all completed.
 * The only difference between this and native Promise.all() is that these
 * promises will _all_ be resolved/rejected before the final Promise (containing
 * all the results) is returned. With native Promise.all(), the first unhandled
 ...
 * (this will cause all the results to be returned and any Errors
 * will be returned in place of the results)
