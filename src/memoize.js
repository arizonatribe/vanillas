...
/**
 * Takes a snapshot of the input args and the output result for a provided function,
 ...
 * skipped the next time the same values are passed to it
 * @returns {Function} A memoized version of the original function. It will
 * cache the input values supplied to it each time it is used
 */
function memoize(fn) {
  const cache = {}
  function inner(...args) {
