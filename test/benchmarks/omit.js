...
test("omit", benchmark => {
  benchmark(
    () => omit(exclude, pantheon),
    "Vanillas \"omit\""
  )
  benchmark(
    () => _.omit(pantheon, exclude),
    "Lodash \"omit\""
  )
  benchmark(
    () => R.omit(exclude, pantheon),
    "Ramda \"omit\""
  )
  benchmark(
    () => Fx.omit(exclude, pantheon),
    "FxJs \"omit\""
  )
  benchmark(
    () => Object
...
test("curriedOmit", benchmark => {
  benchmark(
    () => curriedOmit(["Jupiter", "Saturn", "Neptune"])(pantheon),
    "Vanillas (curried) \"omit\""
  )
  benchmark(
    () => R.omit(["Jupiter", "Saturn", "Neptune"])(pantheon),
    "Ramda (curried) \"omit\""
  )
  benchmark(
    () => Fx.omit(["Jupiter", "Saturn", "Neptune"])(pantheon),
    "FxJs (curried) \"omit\""
  )
})
