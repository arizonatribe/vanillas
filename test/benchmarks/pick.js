...
test("pick", benchmark => {
  benchmark(
    () => pick(["Mercury", "Venus", "Mars"], solarSystem),
    "Vanillas \"pick\""
  )
  benchmark(
    () => _.pick(solarSystem, ["Mercury", "Venus", "Mars"]),
    "Lodash \"pick\""
  )
  benchmark(
    () => R.pick(["Mercury", "Venus", "Mars"], solarSystem),
    "Ramda \"pick\""
  )
  benchmark(
    () => Fx.pick(["Mercury", "Venus", "Mars"], solarSystem),
    "FxJs \"pick\""
  )
  benchmark(
...
test("curriedPick", benchmark => {
  benchmark(
    () => curriedPick(["Mercury", "Venus", "Mars"])(solarSystem),
